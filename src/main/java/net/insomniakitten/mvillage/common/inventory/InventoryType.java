...
public enum InventoryType implements IContainerType {
    ...
    private final int rows, columns, slotsX, slotsY;
    private final ResourceLocation guiTexture;
    private final int textureWidth, textureHeight;

    InventoryType(int rows, int columns, int slotsX, int slotsY, ResourceLocation tex, int width, int height) {
        this.rows = rows;
